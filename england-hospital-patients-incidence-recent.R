...
p <- plot(i[(rows-last):(rows)], fit=fit.second, color="blue", border = "white") +
  ...
  # Add labels
  labs(title=paste("England COVID-19 Patients in Hospital"), 
...
ggsave(plot=p, filename = paste("~/Desktop/england-patients-in-hospital-recent-", i$dates[rows], ".png", sep=""), device="png", dpi=300, height = 15 , width = 15, units = "cm")
